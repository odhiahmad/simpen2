    ...
    public function index()
    {
        ...
        if (request()->ajax()) { 
            ...
            if(Auth::user()->jabatan !== 'Admin'){
                ...
                return DataTables::of(Pengadaan::with('getperusahaan')->where(['id_mp1' => 1])->whereIn('id',$idPengadaan)->latest()->get())
                ...
                return DataTables::of(Pengadaan::with('getperusahaan')->where(['id_mp1' => 1])->whereIn([''])->latest()->get())
                ->addColumn('upload', function ($data) {
