...
class JobCardSpbjController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return DataTables::of(Pengadaan::with(['getMp1', 'getMp2'])->where(['id_mp1' => '3'])->latest()->get())
    ...
    public function tambahPengadaan()
    {
        ...
        return view('pages/user/job-card/spbj/tambahPengadaanSpbj', compact([
            'dataCoo',
            'dataPenerbitCoo',
            'dataPenerbitGaransi',
            'dataSistemDenda',
    ...
    public function store(Request $request)
    {
        ...
        if ($pengadaan->save()) {
            $pengadaanDetail = new PengadaanDetailSpbj();
