...
namespace App\Http\Controllers\JobCard\Spk\JasaLainnya;
...
class SpkJasaLainnyaController extends Controller
{
    public function index()
    {
        if (request()->ajax()) {
            return DataTables::of(Pengadaan::with(['getMp1','getMp2'])->where(['id_mp1' => 2,'id_mp2'=>6])->latest()->get())
        ...
        return view('pages/user/job-card/spk/jasa-lainnya/indexPengadaan');
    }
    ...
    {
        return view('pages/user/job-card/spk/jasa-lainnya/row-details');
    }
    ...
    public function indexUpdateView(Request $request)
    {
        ...
        return view('pages/user/job-card/spk/jasa-lainnya/updatePengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataPengadaan',
            'dataBagian',
    ...
    public function tambahPengadaan()
    {
        ...
        return view('pages/user/job-card/spk/jasa-lainnya/tambahPengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataJabatanPengawas',
            'dataBagian',
