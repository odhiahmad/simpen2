...
namespace App\Http\Controllers\JobCard\Spk\JasaKonstruksi;
...
class SpkJasaKonstruksiController extends Controller
{
    public function index()
    {
        if (request()->ajax()) {
            return DataTables::of(Pengadaan::with(['getMp1','getMp2'])->where(['id_mp1' => 2,'id_mp2'=>5])->latest()->get())
        ...
        return view('pages/user/job-card/spk/jasa-konstruksi/indexPengadaan');
    }
    ...
    {
        return view('pages/user/job-card/spk/jasa-konstruksi/row-details');
    }
    ...
    public function indexUpdateView(Request $request)
    {
        ...
        return view('pages/user/job-card/spk/jasa-konstruksi/updatePengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataPengadaan',
            'dataBagian',
    ...
    public function tambahPengadaan()
    {
        ...
        return view('pages/user/job-card/spk/jasa-konstruksi/tambahPengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataJabatanPengawas',
            'dataBagian',
