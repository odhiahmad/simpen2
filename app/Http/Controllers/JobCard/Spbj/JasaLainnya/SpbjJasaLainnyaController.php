...
namespace App\Http\Controllers\JobCard\Spbj\JasaLainnya;
...
class SpbjJasaLainnyaController extends Controller
{
    public function index()
    {
        if (request()->ajax()) {
            return DataTables::of(Pengadaan::with(['getMp1','getMp2'])->where(['id_mp1' => 3,'id_mp2'=>10])->latest()->get())
        ...
        return view('pages/user/job-card/spbj/jasa-lainnya/indexPengadaan');
    }
    ...
    {
        return view('pages/user/job-card/spbj/jasa-lainnya/row-details');
    }
    ...
    public function downloadSpkBarang()
    {
        ...
        $file = public_path('spk') . "/" . 'spk-jasa-lainnya.doc';
    ...
    public function indexUpdateView(Request $request)
    {
        ...
        return view('pages/user/job-card/spbj/jasa-lainnya/updatePengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataPengadaan',
            'dataBagian',
    ...
    public function tambahPengadaan()
    {
        ...
        return view('pages/user/job-card/spbj/jasa-lainnya/tambahPengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataJabatanPengawas',
            'dataBagian',
