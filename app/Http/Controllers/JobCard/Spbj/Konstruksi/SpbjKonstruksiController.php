...
namespace App\Http\Controllers\JobCard\Spbj\Konstruksi;
...
class SpbjKonstruksiController extends Controller
{
    public function index()
    {
        if (request()->ajax()) {
            return DataTables::of(Pengadaan::with(['getMp1','getMp2'])->where(['id_mp1' => 3,'id_mp2'=>11])->latest()->get())
        ...
        return view('pages/user/job-card/spbj/konstruksi/indexPengadaan');
    }
    ...
    {
        return view('pages/user/job-card/spbj/konstruksi/row-details');
    }
    ...
    public function downloadSpkBarang()
    {
        ...
        $file = public_path('spk') . "/" . 'spk-konstruksi.doc';
    ...
    public function indexUpdateView(Request $request)
    {
        ...
        return view('pages/user/job-card/spbj/konstruksi/updatePengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataPengadaan',
            'dataBagian',
    ...
    public function tambahPengadaan()
    {
        ...
        return view('pages/user/job-card/spbj/konstruksi/tambahPengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataJabatanPengawas',
            'dataBagian',
