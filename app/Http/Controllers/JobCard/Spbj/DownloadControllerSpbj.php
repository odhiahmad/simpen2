...
class DownloadControllerSpbj extends Controller
{
    ...
    public function downloadSpbj($id){
        ...
        $worksheet->setCellValue('A8', 'Nomor SPBJ : '.$dataDetail->hps_nomor);
        $worksheet->setCellValue('A9', 'Tanggal : '.$dataDetail->hps_tanggal);
        ...
        $worksheet->setCellValue('H16', $dataDetail->undangan_pengadaan_langsung_tanggal);
        $worksheet->setCellValue('H17', $dataDetail->ba_hasil_klarifikasi_dan_nego_penawaran_tanggal);

        $worksheet->setCellValue('C82', $data->direksi);
        $worksheet->setCellValue('F82', $data->manager);
