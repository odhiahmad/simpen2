...
namespace App\Http\Controllers\JobCard\Spbj\Barang;
...
class SpbjBarangController extends Controller
{
    public function index()
    {
        if (request()->ajax()) {
            return DataTables::of(Pengadaan::with(['getMp1','getMp2'])->where(['id_mp1' => 3,'id_mp2'=>8])->latest()->get())
        ...
        return view('pages/user/job-card/spbj/barang/indexPengadaan');
    }
    ...
    {
        return view('pages/user/job-card/spbj/barang/row-details');
    }
    ...
    public function indexUpdateView(Request $request)
    {
        ...
        return view('pages/user/job-card/spbj/barang/updatePengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataPengadaan',
            'dataBagian',
    ...
    public function tambahPengadaan()
    {
        ...
        return view('pages/user/job-card/spbj/barang/tambahPengadaan', compact([
            'dataPerusahaan',
            'dataPosAnggaran',
            'dataJabatanPengawas',
            'dataBagian',
