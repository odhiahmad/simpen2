...
class JobCardController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return DataTables::of(Pengadaan::with(['getMp1', 'getMp2'])->where(['id_mp1' => '2'])->latest()->get())
    ...
    public function indexUpdateView($id, $id1, $id2)
    {
        ...
        $dataPengadaanDetail = PengadaanDetailSpk::where('id_pengadaan', $id)->first();
    ...
    public function tambahPengadaan()
    {
        ...
        return view('pages/user/job-card/spk/tambahPengadaan', compact([
            'dataCoo',
            'dataPenerbitCoo',
            'dataPenerbitGaransi',
            'dataSistemDenda',
...
//            'vfmc2' => $request->vfmc2,
    ...
    public function store(Request $request)
    {
        ...
        if ($pengadaan->save()) {
            $pengadaanDetail = new PengadaanDetailSpk();
