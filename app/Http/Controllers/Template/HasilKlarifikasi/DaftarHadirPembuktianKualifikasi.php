...
class DaftarHadirPembuktianKualifikasi
{
    public function DaftarHadirPembuktianKualifikasi($id){
        ...
        $table->addCell(5000)->addText(
            ': EVALUASI DOKUMEN PENAWARAN '.$data->tempat_penyerahan
            ,array('alignment'=>'center','name' => 'Arial', 'size' => 10),$paragraphOptions
        );
        ...
        $objWriter->save(public_path('data-pengadaan/hasil-klarifikasi/' . $data->judul . '2.docx'));
    }
}
