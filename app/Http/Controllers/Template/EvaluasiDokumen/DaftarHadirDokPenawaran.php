...
class DaftarHadirDokPenawaran
{
    public function DaftarHadirDokPenawaran($id){
        ...
        $objWriter->save(public_path('data-pengadaan/evaluasi-dokumen/' . $data->judul.$data->id . '3.docx'));
    }
}
