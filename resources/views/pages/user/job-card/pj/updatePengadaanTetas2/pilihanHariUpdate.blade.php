...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->undangan_aanwijzing_direksi_pekerjaan_nomor}}" id="nppv5"
               name="nppv5" class="form-control m-input">
        <span class="m-form__help"></span>
    </div>
    <div class="col-lg-1">
        <input type="text" value="{{$dataPengadaan->undangan_aanwijzing_direksi_pekerjaan_jumlah}}"
    ...
    <div class="col-lg-2">
        <input
            value="{{$dataPengadaan->undangan_aanwijzing_direksi_pekerjaan_tgl}}"
            name="undangan_aanwijzing_direksi_pekerjaan_tgl"
            id="undangan_aanwijzing_direksi_pekerjaan_tgl"
            type="text" class="form-control" readonly placeholder="Tanggal"/>
    </div>
    <div class="col-lg-1">
        <input value="{{$dataPengadaan->undangan_aanwijzing_direksi_pekerjaan_hari}}" name="undangan_aanwijzing_direksi_pekerjaan_hari"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->undangan_klarifikasi_dan_nego_penawaran_nomor}}" id="nppv14"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->ba_hasil_klarifikasi_dan_nego_penawaran_nomor}}" id="nppv15"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->laporan_hasil_evaluasi_nomor}}" id="nppv16"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->nd_usulan_penetapan_calon_pemenang_nomor}}" id="nppv17"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->nd_penetapan_calon_pemenang_nomor}}" id="nppv18"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->pengumuman_calon_pemenang_nomor}}" id="nppv19"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->penunjukan_pemenang_nomor}}" id="nppv20"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->skkp_nomor}}" id="nppv21"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->undangan_cda_nomor}}" id="nppv22"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->cda_nomor}}" id="nppv23"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->pj_nomor}}" id="nppv24"
...
<div class="form-group m-form__group row">
    ...
    <div class="col-lg-4">
        <input type="text" value="{{$dataPengadaan->bastl_nomor}}" id="nppv25"
