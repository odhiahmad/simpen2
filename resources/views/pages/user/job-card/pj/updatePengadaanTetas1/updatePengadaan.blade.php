...
@section('content')
            ...
            <div class="m-portlet">
                ...
                <form method="post" id="sample_form" enctype="multipart/form-data"
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control m-input"
                                       value="{{$dataPengadaan->jabatan_direksi}}"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control m-input"
                                       value="{{$dataPengadaan->alamat_penyerahan}}"
                        ...
                        @include('pages.user.job-card.pj.updatePengadaanTetas1.pilihanHariUpdate')
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6">
                                <label>
    ...
    @include('pages.user.job-card.pj.updatePengadaanTetas1.jsUpdate')
    @include('pages.user.job-card.pj.updatePengadaanTetas1.jsUpdatePilihanHari')
@endsection
