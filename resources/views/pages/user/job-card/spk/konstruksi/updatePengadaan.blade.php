                ...
                <form method="post" id="sample_form" enctype="multipart/form-data"
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-2">
                                <a href="{!!url('user/job-card/spk/konstruksi/download-rks/' . $dataPengadaan->id )!!}"
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/job-card/spk/konstruksi/download-shp1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Survey Harga Pasar
                                            </a>
                                            <a href="{!!url('user/job-card/spk/konstruksi/download-shp2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Form Daftar Hadir
                                            </a>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-2">
                                <a href="{!!url('user/job-card/spk/konstruksi/download-hps/' . $dataPengadaan->id )!!}"
                                   class="btn btn-brand btn-sm">
                                    Download
                                </a>
                            </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            @if($dataPengadaan->survei_harga_pasar_tgl != null)
                                <div class="col-lg-2">
                                    <a href="{!!url('user/job-card/spk/konstruksi/download-uplh/' . $dataPengadaan->id )!!}"
                                       class="btn btn-brand btn-sm">
                                        Download
                                    </a>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/job-card/spk/konstruksi/evaluasiDokumen1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Pemasukan Dok Penawaran
                                            </a>
                                            <a href="{!!url('user/job-card/spk/konstruksi/evaluasiDokumen2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Evaluasi Dok Penawaran
                                            </a>
                                            <a href="{!!url('user/job-card/spk/konstruksi/evaluasiDokumen3/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Daftar Hadir
                                            </a>
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/job-card/spk/konstruksi/download-hasilKlarifikasi1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Evaluasi dan Pembuktian Kualifikasi
                                            </a>
                                            <a href="{!!url('user/job-card/spk/konstruksi/download-hasilKlarifikasi2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Daftar Hadir Pembuktian Kualifikasi
                                            </a>
                                            <a href="{!!url('user/job-card/spk/konstruksi/download-hasilKlarifikasi3/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Evaluasi Nego
                                            </a>
                                            <a href="{!!url('user/job-card/spk/konstruksi/download-hasilKlarifikasi4/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/job-card/spk/konstruksi/download-hasilPengadaan1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Hasil Pengadaan Langsung
                                            </a>
                                            <a href="{!!url('user/job-card/spk/konstruksi/download-hasilPengadaan2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            @if($dataPengadaan->survei_harga_pasar_tgl != null)
                                <div class="col-lg-2">
                                    <a href="{!!url('user/job-card/spk/konstruksi/download-ndPenetapan/' . $dataPengadaan->id )!!}"
                                       class="btn btn-brand btn-sm">
                                        Download
                                    </a>
                                </div>
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6">
                            <a href="{!!url('user/job-card/spk/konstruksi/download-spkBarang/')!!}"
                               class="btn btn-brand btn-sm">
                                Download SPK Barang
                            </a>
                            <a href="{!!url('user/job-card/spk/konstruksi/download-daftarKuantitas/')!!}"
                               class="btn btn-brand btn-sm">
        ...
        $(document).ready(function () {
            $('.dynamic').change(function () {
                if ($(this).val() != '') {
                    ...
                    $.ajax({
                        url: "{{route('job-card.spk.konstruksi.fetch')}}",
                        method: "POST",
            ...
            $('#sample_form').on('submit', function (event) {
                ...
                $('#sample_form').on('submit', function (event) {
                    ...
                    if ($('#action').val() == 'Add') {
                        $.ajax({
                            url: '{{route('job-card.spk.konstruksi.inisiasi-pengadaan.update')}}',
                            method: 'POST',
