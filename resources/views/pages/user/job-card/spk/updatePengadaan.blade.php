                ...
                <form method="post" id="sample_form" enctype="multipart/form-data"
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-2">
                                <a href="{!!url('user/jobcard/download-rks/' . $dataPengadaan->id )!!}"
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            @if($dataPengadaan->survei_harga_pasar_tgl != null)
                                <div class="col-lg-2">
                                    <a href="{!!url('user/jobcard/download-uplh/' . $dataPengadaan->id )!!}"
                                       class="btn btn-brand btn-sm">
                                        Download
                                    </a>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/jobcard/evaluasiDokumen1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Pemasukan Dok Penawaran
                                            </a>
                                            <a href="{!!url('user/jobcard/evaluasiDokumen2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Evaluasi Dok Penawaran
                                            </a>
                                            <a href="{!!url('user/jobcard/evaluasiDokumen3/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Daftar Hadir
                                            </a>
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/jobcard/download-hasilKlarifikasi1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Evaluasi dan Pembuktian Kualifikasi
                                            </a>
                                            <a href="{!!url('user/jobcard/download-hasilKlarifikasi2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Daftar Hadir Pembuktian Kualifikasi
                                            </a>
                                            <a href="{!!url('user/jobcard/download-hasilKlarifikasi3/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Evaluasi Nego
                                            </a>
                                            <a href="{!!url('user/jobcard/download-hasilKlarifikasi4/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/jobcard/download-hasilPengadaan1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Hasil Pengadaan Langsung
                                            </a>
                                            <a href="{!!url('user/jobcard/download-hasilPengadaan2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            @if($dataPengadaan->survei_harga_pasar_tgl != null)
                                <div class="col-lg-2">
                                    <a href="{!!url('user/jobcard/download-ndPenetapan/' . $dataPengadaan->id )!!}"
                                       class="btn btn-brand btn-sm">
                                        Download
                                    </a>
                                </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <select class="form-control status" id="status_berakhir" name="status_berakhir">
                                    ...
                                    <option
                                        value="{{$dataPengadaan->status_berakhir}}" selected}}>
