    ...
    <div>
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <a href='{!! url('user/job-card/spbj/konstruksi/tambah') !!}'
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.info', function () {
                ...
                $('#form_result').html('');
                $.ajax({
                    url: "/user/job-card/spbj/konstruksi/" + id + "/info",
                    dataType: "json",
            ...
            $('#ok_button').click(function () {
                $.ajax({
                    url: "/user/job-card/spbj/konstruksi/destroy/" + user_id,
                    beforeSend: function () {
            ...
            var t = $('#user_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/user/job-card/spbj/konstruksi/index",
                },
                columns: [
                    {
                        data: 'judul',
