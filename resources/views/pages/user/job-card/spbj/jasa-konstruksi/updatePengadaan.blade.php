@section('title','SPBJ|BARANG|Update')
@extends('../../../../../../main')
@section('content')
    <div>
                ...
                <form method="post" id="sample_form" enctype="multipart/form-data"
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-2">
                                <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-rks/' . $dataPengadaan->id )!!}"
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-shp1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Survey Harga Pasar
                                            </a>
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-shp2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Form Daftar Hadir
                                            </a>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-2">
                                <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-hps/' . $dataPengadaan->id )!!}"
                                   class="btn btn-brand btn-sm">
                                    Download
                                </a>
                            </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            @if($dataPengadaan->survei_harga_pasar_tgl != null)
                                <div class="col-lg-2">
                                    <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-uplh/' . $dataPengadaan->id )!!}"
                                       class="btn btn-brand btn-sm">
                                        Download
                                    </a>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/evaluasiDokumen1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Pemasukan Dok Penawaran
                                            </a>
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/evaluasiDokumen2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Evaluasi Dok Penawaran
                                            </a>
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/evaluasiDokumen3/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Daftar Hadir
                                            </a>
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-hasilKlarifikasi1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Evaluasi dan Pembuktian Kualifikasi
                                            </a>
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-hasilKlarifikasi2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Daftar Hadir Pembuktian Kualifikasi
                                            </a>
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-hasilKlarifikasi3/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Evaluasi Nego
                                            </a>
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-hasilKlarifikasi4/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                ...
                                <div class="col-lg-2">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-hasilPengadaan1/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                                                Hasil Pengadaan Langsung
                                            </a>
                                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-hasilPengadaan2/' . $dataPengadaan->id )!!}"
                                               class="dropdown-item">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            @if($dataPengadaan->survei_harga_pasar_tgl != null)
                                <div class="col-lg-2">
                                    <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-ndPenetapan/' . $dataPengadaan->id )!!}"
                                       class="btn btn-brand btn-sm">
                                        Download
                                    </a>
                                </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" value="{{$dataPengadaan->spbj_nomor}}" id="nppv10" name="nppv10"
                                       class="form-control m-input">
                                <span class="m-form__help"></span>
                            </div>
                            <div class="col-lg-1">
                            ...
                            <div class="col-lg-2">
                                <input
                                    value="{{$dataPengadaan->spbj_tgl}}"
                                    name="spbj_tgl"
                                    id="spbj_tgl"
                                    type='text' class="form-control" readonly placeholder="Tanggal"/>
                            </div>
                            <div class="col-lg-1">
                                <input name="spbj_hari"
                                       id="spbj_hari"
                                       readonly
                                       value="{{$dataPengadaan->spbj_hari}}"
                                       type="text" class="form-control m-input" placeholder="Hari">
                                <span class="m-form__help"></span>
                            </div>
                            <div class="col-lg-2">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6">
                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-spbjBarang/')!!}"
                               class="btn btn-brand btn-sm">
                                Download SPBJ Barang
                            </a>
                            <a href="{!!url('user/job-card/spbj/jasa-konstruksi/download-daftarKuantitas/')!!}"
                               class="btn btn-brand btn-sm">
        ...
        $(document).ready(function () {
            $('.dynamic').change(function () {
                if ($(this).val() != '') {
                    ...
                    $.ajax({
                        url: "{{route('job-card.spbj.jasa-konstruksi.fetch')}}",
                        method: "POST",
            ...
            $("#rks_tgl,#spbj_tgl,#tanggal_diterima_panitia,#tanggal,#nd_penetapan_pemenang_tgl,#nd_usulan_tetap_pemenang_tgl,#ba_hasil_pengadaan_langsung_tgl,#survey_harga_pasar_tgl, #hps_tgl, #undangan_pengadaan_langsung_tgl,#pemasukan_dok_penawaran_tgl_sd,#pemasukan_dok_penawaran_tgl_dari,#evaluasi_dokumen_tgl_sd,#evaluasi_dokumen_tgl_dari,#ba_hasil_klarifikasi_tgl").datepicker({
                format: 'yyyy-mm-dd',
                todayHighlight: !0,
            ...
            $("#tanggal_diterima_panitia").change(function () {
                ...
                $('#spbj_hari').val(hari[getTanggal1.getDay()])
            ...
            $value.on('input', function (e) {
                ...
                if ($('#fungsi_pembangkit').val() === 'Pembangkit') {
                    ...
                    $nppv10.val('0' + total + '.SPBJ/DAN.02.01/210200/' + $('#tahun').val());
                    ...
                    $nppv10.val('0' + total + '.SPBJ/DAN.02.07/210200/' + $('#tahun').val());
            ...
            $valueTgl0.on('input', function (e) {
                ...
                $('#spbj_tgl').datepicker('setDate', tambahTglM);
                $('#spbj_hari').val(hari[tambahTglM.getDay()])
            ...
            $valueTgl12.on('input', function (e) {
                ...
                $('#spbj_tgl').datepicker('setDate', getFull12);
                $('#spbj_hari').val(hari[getFull12.getDay()])
            ...
            $('#sample_form').on('submit', function (event) {
                ...
                $('#sample_form').on('submit', function (event) {
                    ...
                    if ($('#action').val() == 'Add') {
                        $.ajax({
                            url: '{{route('job-card.spbj.jasa-konstruksi.inisiasi-pengadaan.update')}}',
                            method: 'POST',
