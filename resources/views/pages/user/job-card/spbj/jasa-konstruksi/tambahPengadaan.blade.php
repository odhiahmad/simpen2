@section('title','SPBJ | BARANG | Tambah')
@extends('../../../../../../main')
@section('content')
    <div>
        ...
        <div class="m-content">
            <div class="m-portlet">
                ...
                <form method="post" id="sample_form" enctype="multipart/form-data"
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control m-input" id="tahun" name="tahun"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control m-input" id="lingkup_pekerjaan"
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control m-input" id="pengguna" name="pengguna"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control m-input" readonly id="direksi" name="direksi"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control m-input no_proses_pengadaan"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" value="0" class="form-control m-input" id="nilai_kontrak" name="nilai_kontrak"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" value="0" class="form-control m-input" readonly id="sisa_anggaran"
                                       name="sisa_anggaran">
                                <span class="m-form__help"></span>
                            </div>
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6">
                            <a href="{!!url('user/inisiasi-pengadaan/download-spbjBarang/')!!}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#sample_form').on('submit', function (event) {
                ...
                if ($('#action').val() == 'Add') {
                    $.ajax({
                        url: "{{ route('job-card.spbj.jasa-konstruksi.inisiasi-pengadaan.insert') }}",
                        method: "POST",
